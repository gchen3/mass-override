...
\hypersetup{
  pdftitle={The Causes and Costs of Municipal Tax Overrides},
  pdfauthor={Gang Chen 1; Huimin (Amy) Chen 2},
  pdfkeywords={municipal government, tax override, Massachusetts},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\date{October 1, 2024}
\title{\bf The Causes and Costs of Municipal Tax Overrides}
\author{
Gang Chen 1\thanks{true}\\
Department of Public Administration and Policy, University at Albany
SUNY\\
and\\Huimin (Amy) Chen 2\\
Department of Accounting, University of Massachusetts at Lowell\\
}
\maketitle
...
\bigskip
\begin{abstract}
In this paper, we use tax override data in municipal governments in
Massachusetts to examine the causes and costs.
\end{abstract}

\noindent%
{\it Keywords:} municipal government, tax override, Massachusetts
\vfill
