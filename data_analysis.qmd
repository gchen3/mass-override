...
override_sum_type |> 
  gt() |>
  tab_header(
    title = md("**Overrides by type 1990-2024**")
  ) |>
  tab_source_note(
    source_note = "Source: Department of Local Services proposition 2 1/2 override votes."
  ) |>
  cols_label(
    votetype = md("Type of<br>Override"),
    average_yes_percent = md("Percent of<br>Yes vote"),
    average_win = md("Percent of<br>Win"),
    count = md("Number of<br>Overrides")
  ) |>
  fmt_percent(
...
override_sum_year|> 
  gt() |>
  tab_header(
    title = md("**Overrides by year 1990-2024**")
  ) |>
  tab_source_note(
    source_note = "Source: Department of Local Services proposition 2 1/2 override votes."
  ) |>
...
override_sum_abtowns |> 
  gt() |>
  tab_header(
    title = md("**Acton and Boxborough Town Overrides 1990-2024**")
  ) |>
  tab_source_note(
    source_note = "Source: Department of Local Services proposition 2 1/2 override votes."
  ) |>
